...
class parser:
    ...
    def __init__(self):
        ...
        self.drop_actions = ["drop","remove", "leave"]
        self.investigate_actions = ["investigate", "look", "search", "inspect"]
    ...
    def sense_investigate(self, string):
        return self.sense_all(string, self.investigate_actions)
